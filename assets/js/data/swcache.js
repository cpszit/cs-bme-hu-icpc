const resource = [
  /* --- CSS --- */
  '/cs-bme-icpc-new/assets/css/jekyll-theme-chirpy.css',

  /* --- PWA --- */
  '/cs-bme-icpc-new/app.js',
  '/cs-bme-icpc-new/sw.js',

  /* --- HTML --- */
  '/cs-bme-icpc-new/index.html',
  '/cs-bme-icpc-new/404.html',

  
    '/cs-bme-icpc-new/student-group/',
  
    '/cs-bme-icpc-new/contest/',
  
    '/cs-bme-icpc-new/preparation/',
  
    '/cs-bme-icpc-new/previous-site/',
  
    '/cs-bme-icpc-new/categories/',
  
    '/cs-bme-icpc-new/tags/',
  
    '/cs-bme-icpc-new/archives/',
  
    '/cs-bme-icpc-new/contact/',
  ...
  /* --- Favicons & compressed JS --- */
    ...
    '/cs-bme-icpc-new/assets/js/dist/misc.min.js',
    '/cs-bme-icpc-new/assets/js/dist/page.min.js',
    '/cs-bme-icpc-new/assets/js/dist/post.min.js'
];
